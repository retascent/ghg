...
use ghg_common::{assign_shared, clone, clone_all, read_shared};
...
fn load_textures_async(context: WebGl2RenderingContext, done: Rc<RefCell<bool>>) {
	...
	// This pattern is still a work in progress. It's not clean, and would be
	// much better and easier to understand if I used a real graph
...
pub fn get_animation_loop(
	...
	let planet_meshes_and_buffers = generate_drawable_sphere(20, 20, planet_shader.clone());
