...
impl Camera {
    ...
    pub fn position(&self) -> nglm::Vec3 {
        self.position
    }

    pub fn set_position(&mut self, new_position: nglm::Vec3) {
        self.position = new_position;
    }

    pub fn target(&self) -> nglm::Vec3 {
    ...
    pub fn move_target_along_sphere(&mut self, sphere_movement: &nglm::Vec2, sensitivity: f32) {
        let radians_movement = nglm::vec2(sphere_movement[0].to_radians(), sphere_movement[1].to_radians());
    ...
    pub fn orbit_around_target(&mut self, target: &nglm::Vec3, sphere_movement: &nglm::Vec2, sensitivity: f32) {
    ...
    pub fn up(&self) -> nglm::Vec3 {
        -1.0 * nglm::cross(&self.forward, &self.right())
    }

    fn forward_xz_plane(&self) -> nglm::Vec2 {
        nglm::vec2(self.forward[0], self.forward[2])
    }

    fn yaw_radians(&self) -> f32 {
        self.forward[2].atan2(self.forward[0])
    }

    fn pitch_radians(&self) -> f32 {
        self.forward[1].atan2(self.forward_xz_plane().magnitude())
    }
}
