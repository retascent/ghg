...
impl LightParameters {
    pub fn new(shader_context: &ShaderContext) -> Self {
        ...
        let ambient_color = uniform::init_smart_vec3("u_ambientColor", &shader_context, nglm::vec3(0.8, 0.8, 1.0));
        let light_color = uniform::init_smart_vec3("u_lightColor", &shader_context, nglm::vec3(1.0, 1.0, 1.0));
